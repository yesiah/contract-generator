...
contents1 = """國內個別旅遊定型化契約書範本
交通部觀光局100年1月17日觀業字第0990044124號函修正發布
（本契約審閱期間一日，{start_date} 由甲方攜回審閱）
立契約書人
旅客姓名：{party_a_name} (以下稱甲方)
旅行社名稱：{party_b_name} (以下稱乙方)
...
第四條(集合及出發時地)
甲方應於民年    月 　 日    時　  分準時集合出發。甲方未準時到達致無法出發時，亦未能中途加入旅遊者，視為甲方解除契約，乙方得依第十一條之規定處理。
第五條(旅遊費用及其涵蓋內容)
...
　　　　　　　電話或電傳：
　
簽約日期：中華民國 {signature_date}

（如未記載以交付訂金日為簽約日期）
簽約地點：               
（如未記載以甲方住所地為簽約地）"""

templates = {name1: contents1}
